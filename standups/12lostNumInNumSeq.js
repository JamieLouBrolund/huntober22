...
//Put arr in new variable arrSum and find sum

function findDeletedNumber(arr, mixArr) {
    //Put arr in new var arrSum and find sum
    let arrSum = arr.reduce((a,c) => a + c, 0)
    //put mixArr in new var mixSum and find sum
    let mixSum = mixArr.reduce((a,c) => a + c, 0)
    //subtract both sums to get remainder
    console.log(arrSum - mixSum)   
}
